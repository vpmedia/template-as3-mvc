 ...
 */
public class ShareContextMenuItem extends BaseContextMenuItem {
    /**
     * Constructor
     */
    public function ShareContextMenuItem() {
        title = "Share";
        super();
    ...
    override protected function eventHandler(event:ContextMenuEvent):void {
        var url:String = "http://api.addthis.com/oexchange/0.8/offer?url=" + "http%3A%2F%2Fwww.vpmedia.eu";
