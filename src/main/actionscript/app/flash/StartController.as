...
public class StartController extends BaseController {
    private static const LOG:ILogger = getLogger("StartController");
     ...
     */
    public function StartController(view:IBaseView, model:BaseModel) {
        super(view, model);
    }
     ...
     * @private
     */
    private function get viewContext():StartView {
