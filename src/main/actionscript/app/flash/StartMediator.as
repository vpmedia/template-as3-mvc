...
public class StartMediator extends BaseMediator {
    private static const LOG:ILogger = getLogger("StartMediator");

    /**
     * Constructor
     * @param view IBaseView
     */
    public function StartMediator(view:IBaseView) {
        super(view);
    }
     ...
     * TBD
     */
    public function get view():StartView {
        return StartView(_view);
    }

    /**
     * TBD
     */
    public function get controller():StartController {
        return StartController(_view.controller);
    }
